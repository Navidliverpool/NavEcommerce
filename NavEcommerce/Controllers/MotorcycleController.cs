...
namespace NavEcommerce.Controllers
{
    ...
    {
        private readonly ICRUDOperations<Motorcycle> _motorcycleContext;
        public MotorcycleController(ICRUDOperations<Motorcycle> motorcycleContext)
        {
            motorcycleContext = _motorcycleContext;
        }
